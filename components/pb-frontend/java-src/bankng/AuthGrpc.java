...
public final class AuthGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "bankng.Auth";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<bankng.FirstFactorRequest,
      bankng.FirstFactorReply> getFirstFactorMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "FirstFactor",
      requestType = bankng.FirstFactorRequest.class,
      responseType = bankng.FirstFactorReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bankng.FirstFactorRequest,
      bankng.FirstFactorReply> getFirstFactorMethod() {
    io.grpc.MethodDescriptor<bankng.FirstFactorRequest, bankng.FirstFactorReply> getFirstFactorMethod;
      ...
      synchronized (AuthGrpc.class) {
        if ((getFirstFactorMethod = AuthGrpc.getFirstFactorMethod) == null) {
          AuthGrpc.getFirstFactorMethod = getFirstFactorMethod =
              io.grpc.MethodDescriptor.<bankng.FirstFactorRequest, bankng.FirstFactorReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "FirstFactor"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bankng.FirstFactorRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bankng.FirstFactorReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bankng.SecondFactorRequest,
      bankng.SecondFactorReply> getSecondFactorMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SecondFactor",
      requestType = bankng.SecondFactorRequest.class,
      responseType = bankng.SecondFactorReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bankng.SecondFactorRequest,
      bankng.SecondFactorReply> getSecondFactorMethod() {
    io.grpc.MethodDescriptor<bankng.SecondFactorRequest, bankng.SecondFactorReply> getSecondFactorMethod;
    if ((getSecondFactorMethod = AuthGrpc.getSecondFactorMethod) == null) {
      synchronized (AuthGrpc.class) {
        if ((getSecondFactorMethod = AuthGrpc.getSecondFactorMethod) == null) {
          AuthGrpc.getSecondFactorMethod = getSecondFactorMethod =
              io.grpc.MethodDescriptor.<bankng.SecondFactorRequest, bankng.SecondFactorReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SecondFactor"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bankng.SecondFactorRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bankng.SecondFactorReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void firstFactor(bankng.FirstFactorRequest request,
        io.grpc.stub.StreamObserver<bankng.FirstFactorReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getFirstFactorMethod(), responseObserver);
    }

    /**
     */
    default void secondFactor(bankng.SecondFactorRequest request,
        io.grpc.stub.StreamObserver<bankng.SecondFactorReply> responseObserver) {
  ...
  public static final class AuthStub
    ...
    /**
     */
    public void firstFactor(bankng.FirstFactorRequest request,
        io.grpc.stub.StreamObserver<bankng.FirstFactorReply> responseObserver) {
    ...
    /**
     */
    public void secondFactor(bankng.SecondFactorRequest request,
        io.grpc.stub.StreamObserver<bankng.SecondFactorReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class AuthBlockingStub
    ...
    /**
     */
    public bankng.FirstFactorReply firstFactor(bankng.FirstFactorRequest request) {
    ...
    /**
     */
    public bankng.SecondFactorReply secondFactor(bankng.SecondFactorRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AuthFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bankng.FirstFactorReply> firstFactor(
        bankng.FirstFactorRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bankng.SecondFactorReply> secondFactor(
        bankng.SecondFactorRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FIRST_FACTOR:
          serviceImpl.firstFactor((bankng.FirstFactorRequest) request,
              (io.grpc.stub.StreamObserver<bankng.FirstFactorReply>) responseObserver);
          break;
        case METHODID_SECOND_FACTOR:
          serviceImpl.secondFactor((bankng.SecondFactorRequest) request,
              (io.grpc.stub.StreamObserver<bankng.SecondFactorReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bankng.FirstFactorRequest,
              bankng.FirstFactorReply>(
                service, METHODID_FIRST_FACTOR)))
        .addMethod(
          getSecondFactorMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bankng.SecondFactorRequest,
              bankng.SecondFactorReply>(
  ...
  private static abstract class AuthBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bankng.AuthOuterClass.getDescriptor();
    }
