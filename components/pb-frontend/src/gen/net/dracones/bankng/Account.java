...
/**
 * Protobuf type {@code net.dracones.bankng.Account}
 */
public final class Account extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:net.dracones.bankng.Account)
    AccountOrBuilder {
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return net.dracones.bankng.AccountsOuterClass.internal_static_net_dracones_bankng_Account_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return net.dracones.bankng.AccountsOuterClass.internal_static_net_dracones_bankng_Account_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            net.dracones.bankng.Account.class, net.dracones.bankng.Account.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof net.dracones.bankng.Account)) {
      return super.equals(obj);
    }
    net.dracones.bankng.Account other = (net.dracones.bankng.Account) obj;
  ...
  public static net.dracones.bankng.Account parseFrom(
  ...
  public static net.dracones.bankng.Account parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static net.dracones.bankng.Account parseFrom(
  ...
  public static net.dracones.bankng.Account parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static net.dracones.bankng.Account parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static net.dracones.bankng.Account parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(net.dracones.bankng.Account prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:net.dracones.bankng.Account)
      net.dracones.bankng.AccountOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return net.dracones.bankng.AccountsOuterClass.internal_static_net_dracones_bankng_Account_descriptor;
    }
    ...
    // Construct using net.dracones.bankng.Account.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public net.dracones.bankng.Account getDefaultInstanceForType() {
      return net.dracones.bankng.Account.getDefaultInstance();
    }

    @java.lang.Override
    public net.dracones.bankng.Account build() {
      net.dracones.bankng.Account result = buildPartial();
    ...
    @java.lang.Override
    public net.dracones.bankng.Account buildPartial() {
      net.dracones.bankng.Account result = new net.dracones.bankng.Account(this);
      if (bitField0_ != 0) { buildPartial0(result); }
      onBuilt();
      return result;
    }

    private void buildPartial0(net.dracones.bankng.Account result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof net.dracones.bankng.Account) {
        return mergeFrom((net.dracones.bankng.Account)other);
      } else {
    ...
    public Builder mergeFrom(net.dracones.bankng.Account other) {
      if (other == net.dracones.bankng.Account.getDefaultInstance()) return this;
    ...
    // @@protoc_insertion_point(builder_scope:net.dracones.bankng.Account)
  }

  // @@protoc_insertion_point(class_scope:net.dracones.bankng.Account)
  private static final net.dracones.bankng.Account DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new net.dracones.bankng.Account();
  }

  public static net.dracones.bankng.Account getDefaultInstance() {
