...
public final class MuckletGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "bankng.mucklet.Mucklet";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<bankng.mucklet.LookupCharacterRequest,
      bankng.mucklet.LookupCharacterReply> getLookupCharacterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "LookupCharacter",
      requestType = bankng.mucklet.LookupCharacterRequest.class,
      responseType = bankng.mucklet.LookupCharacterReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bankng.mucklet.LookupCharacterRequest,
      bankng.mucklet.LookupCharacterReply> getLookupCharacterMethod() {
    io.grpc.MethodDescriptor<bankng.mucklet.LookupCharacterRequest, bankng.mucklet.LookupCharacterReply> getLookupCharacterMethod;
      ...
      synchronized (MuckletGrpc.class) {
        if ((getLookupCharacterMethod = MuckletGrpc.getLookupCharacterMethod) == null) {
          MuckletGrpc.getLookupCharacterMethod = getLookupCharacterMethod =
              io.grpc.MethodDescriptor.<bankng.mucklet.LookupCharacterRequest, bankng.mucklet.LookupCharacterReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "LookupCharacter"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bankng.mucklet.LookupCharacterRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bankng.mucklet.LookupCharacterReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<bankng.mucklet.SendMessageRequest,
      com.google.protobuf.Empty> getSendMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SendMessage",
      requestType = bankng.mucklet.SendMessageRequest.class,
      responseType = com.google.protobuf.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<bankng.mucklet.SendMessageRequest,
      com.google.protobuf.Empty> getSendMessageMethod() {
    io.grpc.MethodDescriptor<bankng.mucklet.SendMessageRequest, com.google.protobuf.Empty> getSendMessageMethod;
    if ((getSendMessageMethod = MuckletGrpc.getSendMessageMethod) == null) {
      synchronized (MuckletGrpc.class) {
        if ((getSendMessageMethod = MuckletGrpc.getSendMessageMethod) == null) {
          MuckletGrpc.getSendMessageMethod = getSendMessageMethod =
              io.grpc.MethodDescriptor.<bankng.mucklet.SendMessageRequest, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SendMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  bankng.mucklet.SendMessageRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void lookupCharacter(bankng.mucklet.LookupCharacterRequest request,
        io.grpc.stub.StreamObserver<bankng.mucklet.LookupCharacterReply> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getLookupCharacterMethod(), responseObserver);
    }

    /**
     */
    default void sendMessage(bankng.mucklet.SendMessageRequest request,
  ...
  public static final class MuckletStub
    ...
    /**
     */
    public void lookupCharacter(bankng.mucklet.LookupCharacterRequest request,
        io.grpc.stub.StreamObserver<bankng.mucklet.LookupCharacterReply> responseObserver) {
    ...
    /**
     */
    public void sendMessage(bankng.mucklet.SendMessageRequest request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class MuckletBlockingStub
    ...
    /**
     */
    public bankng.mucklet.LookupCharacterReply lookupCharacter(bankng.mucklet.LookupCharacterRequest request) {
    ...
    /**
     */
    public com.google.protobuf.Empty sendMessage(bankng.mucklet.SendMessageRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MuckletFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<bankng.mucklet.LookupCharacterReply> lookupCharacter(
        bankng.mucklet.LookupCharacterRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> sendMessage(
        bankng.mucklet.SendMessageRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOOKUP_CHARACTER:
          serviceImpl.lookupCharacter((bankng.mucklet.LookupCharacterRequest) request,
              (io.grpc.stub.StreamObserver<bankng.mucklet.LookupCharacterReply>) responseObserver);
          break;
        case METHODID_SEND_MESSAGE:
          serviceImpl.sendMessage((bankng.mucklet.SendMessageRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bankng.mucklet.LookupCharacterRequest,
              bankng.mucklet.LookupCharacterReply>(
                service, METHODID_LOOKUP_CHARACTER)))
        .addMethod(
          getSendMessageMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              bankng.mucklet.SendMessageRequest,
  ...
  private static abstract class MuckletBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return bankng.mucklet.MuckletOuterClass.getDescriptor();
    }
