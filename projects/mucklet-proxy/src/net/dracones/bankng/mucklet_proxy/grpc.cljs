(ns net.dracones.bankng.mucklet-proxy.grpc
  (:require ["@grpc/proto-loader" :as protoLoader]
            ["@grpc/grpc-js" :as grpc]
            [net.dracones.bankng.mucklet-proxy.bot :as bot]
...
(def server (let [s (grpc/Server.)]
              (.addService
               s
               (oget proto-descriptor "net.dracones.bankng.mucklet.Mucklet.service")
